...
<div class="min-h-full">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="/php/about.php" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">About</a>
                            <a href="/php/contact.php" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
    ...
    <main>
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <!-- Your content -->
            <p>Olá bem vindo a página sobre.</p>
        </div>
    </main>
</div>
