                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="/php/" class="<?= urlIs('/php/') ? 'bg-gray-900 text-white' : 'text-grey-300'; ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Home</a>
                            <a href="/php/about.php" class="<?= urlIs('/php/about.php') ? 'bg-gray-900 text-white' : 'text-grey-300'; ?> rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-white/5 hover:text-white">About</a>
                            <a href="/php/contact.php" class="<?= urlIs('/php/contact.php') ? 'bg-gray-900 text-white' : 'text-grey-300'; ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
